...
void main() async {
  ...
  player pObj1 =
      player(playerName: "Virat", jerNo: 18, runs: 34000, avrage: 51.22);
  player pObj2 =
      player(playerName: "rohit", jerNo: 45, runs: 22000, avrage: 41.22);
  player pObj3 =
      player(playerName: "msd", jerNo: 7, runs: 24000, avrage: 21.22);
