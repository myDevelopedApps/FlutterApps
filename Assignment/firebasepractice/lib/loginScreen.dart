...
import 'package:firebasepractice/registerScreen.dart';
...
// import 'package:firebase_authentication_practice/registrationScreen.dart';
import 'package:flutter/material.dart';
//import 'package:hello_world/fractice_firebase.dart';
//import 'package:hello_world/registerUI.dart';
            ...
            onTap: () async {
              if (_emailTextEditingController.text.trim().isNotEmpty &&
                ...
                try {
                  ...
                  log("C2W : ERROR :${error.code}" as num);
                  log("C2W : ERROR :${error.message}" as num);
                }
              }
            },
            child: Container(
