...
import 'package:graph_section/colorwise.dart';
import 'package:graph_section/poolingwise.dart';
import 'package:graph_section/villagewise.dart';
import 'package:graph_section/villagewiseMF.dart';
...
class VoterDashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final sections = [
      ...
      {'title': 'Pollingwise Voter', 'widget': SplineAreaChart()},
    ];
